...
namespace LandingPageMP.Controllers
{
    public class InformationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Email,Phone,Message,Status")] Information information)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Email,Phone,Message,Status")] Information information)
        {
            if (ModelState.IsValid)
            {
